            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <section className="glass-card p-8 space-y-4">
                    ...
                    <ol className="text-sm text-slate-400 space-y-2 list-decimal pl-5">
                        <li>
                            <code className="text-cosmos-400">Set-Location web_sota</code> then{' '}
                            <code className="text-cosmos-400">.\start.ps1</code>
                        </li>
                        <li>Open <strong className="text-slate-200">http://127.0.0.1:10988</strong></li>
                        <li>
                            <strong className="text-slate-200">Settings</strong> — pick Ollama, LM Studio, or OpenAI + model
                        </li>
                        <li>
                            <strong className="text-slate-200">Chat</strong> — Vienna preprompt chips or free text
                        </li>
                    </ol>
                </section>
                ...
                <section className="glass-card p-8 space-y-4">
                    ...
                    <ul className="text-sm text-slate-400 space-y-2">
                        ...
                        <li>Backend + MCP: <code className="text-cosmos-400">10922</code> — <code>/mcp</code></li>
                        <li>
                            <strong className="text-slate-200">ViLife</strong> = this app (
                            <code>vienna-life-assistant</code>)
                        </li>
                        <li>
                            <strong className="text-slate-200">vla-mcp</strong> = robotics only — not this app
                        </li>
                        <li>
                            <code>vienna-live-mcp</code> deprecated — use ViLife <code>web_sota</code>
                        </li>
                    </ul>
                </section>
                ...
                <section className="glass-card p-8 space-y-4">
                    ...
                    <div className="bg-black/40 rounded-xl p-4 font-mono text-[10px] text-slate-400 space-y-2 border border-white/[0.06] overflow-x-auto">
                        ...
                        <p><span className="text-emerald-400">GET</span> /api/life/expenses/summary</p>
                        <p><span className="text-emerald-400">GET</span> /api/life/travel/upcoming</p>
                        <p><span className="text-emerald-400">GET</span> /api/vienna/transport</p>
                        <p><span className="text-emerald-400">GET</span> /api/llm/status</p>
                        <p><span className="text-emerald-400">POST</span> /api/llm/chat</p>
                        <p><span className="text-emerald-400">GET</span> /api/capabilities</p>
                        <p><span className="text-emerald-400">GET</span> /api/skills</p>
                    </div>
                </section>
                ...
                <section className="glass-card p-8 space-y-4">
                    ...
                    <div className="text-sm text-slate-400 space-y-2">
                        <p>
                            Tool <code className="text-cosmos-400">vienna_life(operation=...)</code>:
                        </p>
                        <p className="text-[10px] font-mono text-slate-500">
                            calendar_today · todo_list · expense_summary · shopping_list · life_brief · fleet_overview · health · help
                        </p>
                        <p>
                            Agentic: <code className="text-cosmos-400">vienna_life_agentic(goal=...)</code>
                        </p>
                        <p>
                            Cursor: <code className="text-cosmos-400">fleet_call(server=&quot;vienna-life&quot;, ...)</code>
                        </p>
                    </div>
                </section>
                ...
                <section className="glass-card p-8 space-y-4 md:col-span-2">
                    ...
                    <ul className="text-sm text-slate-400 space-y-2 list-disc pl-5">
                        ...
                        <li>Port squatters — re-run <code className="text-cosmos-400">start.ps1</code> (kills 10988/10922)</li>
                        <li>MCP from Cursor — backend must be up on 10922 before connecting</li>
                    </ul>
                </section>
            </div>
        </div>
