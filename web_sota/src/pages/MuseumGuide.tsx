			...
			<div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
				...
				<div className="flex flex-col gap-6">
					<div className="glass-card p-10 flex-1 relative overflow-hidden group border-indigo-500/20 hover:border-indigo-500/40">
						...
						<p className="text-sm text-slate-400 leading-relaxed italic pr-12 mb-8">
				...
				{exhibitions.map((ex) => (
					...
					>
						<div className="flex justify-between items-start mb-8">
							...
							<span className="text-[9px] font-black uppercase tracking-widest px-2 py-1.5 rounded-full bg-white/[0.05] text-slate-500 border border-white/[0.08]">
								Exhibition
							</span>
						</div>

						<div className="space-y-1.5 mb-8">
							<h4 className="text-[10px] font-black text-cosmos-400 uppercase tracking-widest">
								{ex.museum}
							</h4>
