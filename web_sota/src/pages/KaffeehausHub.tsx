			...
			<div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
				<div className="lg:col-span-2 relative group overflow-hidden rounded-[2.5rem] border border-white/[0.1] bg-gradient-to-br from-slate-900 via-[#050505] to-slate-900 shadow-2xl">
					...
					<div className="relative p-10 h-full flex flex-col justify-end min-h-[400px]">
						...
						<h2 className="text-6xl font-black text-white tracking-tighter uppercase mb-4 group-hover:translate-x-2 transition-transform duration-500">
							Café Berg
						</h2>
						<p className="text-xl text-slate-300 max-w-2xl leading-relaxed mb-8">
							Berggasse 8. The cultural anchor of Alsergrund. Perfect balance of
							history and modernized intellectual vibe.
						</p>
				...
				<div className="glass-card p-10 flex flex-col justify-center items-center text-center border-cosmos-500/30 relative overflow-hidden">
					...
					<h3 className="text-[11px] font-black uppercase tracking-[0.3em] text-cosmos-400 mb-4">
						Melange of the Day
					</h3>
				...
				{cafes.map((cafe) => (
					<div
						...
						className={`glass-card p-6 group transition-all duration-300 relative border-l-4 ${
							cafe.is_aida
								? "border-l-[#E89AB0] hover:bg-[#E89AB0]/[0.02]"
								: cafe.is_favorite
									? "border-l-emerald-500 hover:bg-emerald-500/[0.02]"
