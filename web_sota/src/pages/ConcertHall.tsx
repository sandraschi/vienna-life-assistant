		...
		<div className="space-y-8 page-enter animate-in fade-in slide-in-from-bottom-4 duration-700">
				...
				<div className="group relative flex items-center bg-white/[0.03] p-1.5 rounded-3xl border border-white/[0.08] hover:border-cosmos-500/30 transition-all cursor-pointer">
					<div className="flex -space-x-3 px-3">
						{[1, 2, 3].map((i) => (
							<div
								key={i}
								className="w-8 h-8 rounded-full border-2 border-[#050505] bg-slate-800 flex items-center justify-center"
							>
			...
			<div className="relative group overflow-hidden rounded-[3rem] border border-white/[0.1] bg-[#0A0A0A]">
				...
				<div className="relative p-12 lg:p-16 h-full flex flex-col justify-end min-h-[500px]">
					...
					<h2 className="text-7xl font-black text-white tracking-tighter uppercase leading-none mb-6">
						Musikverein
					</h2>
					<p className="text-2xl text-slate-300 max-w-2xl leading-relaxed italic mb-10">
						Experience the world's finest acoustics in the Golden Hall. Tonight,
						Vivaldi's masterpiece returns home.
					</p>
			...
			<div className="grid grid-cols-1 md:grid-cols-3 gap-6">
				{concerts.map((concert) => (
					<div
						key={concert.venue}
						className="glass-card p-8 group hover:translate-y-[-4px] transition-all duration-300 border-cosmos-500/10 hover:border-cosmos-500/40"
					>
						...
						<div className="space-y-2">
							<h3 className="text-sm font-black text-cosmos-400 uppercase tracking-widest">
								{concert.venue}
							</h3>
							<p className="text-2xl font-black text-white uppercase tracking-tighter leading-snug group-hover:text-cosmos-300 transition-colors">
								{concert.performance}
							</p>
						</div>
