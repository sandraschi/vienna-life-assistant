...
export default function Skills() {
    ...
    return (
        <div className="space-y-8 page-enter">
            <div>
                <h1 className="text-4xl font-black gradient-text tracking-tighter uppercase italic">Skills</h1>
                <p className="text-slate-500 mt-2 text-sm">Vienna skill pack · MCP prompts</p>
            </div>

            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                <div className="glass-card p-4 space-y-2">
                    <p className="text-[10px] font-black text-slate-600 uppercase tracking-widest px-2 mb-2">Vienna skills</p>
                    {skills.map((s) => (
                        <button
                            key={s.name}
                            type="button"
            ...
            {prompts.length > 0 && (
                <div className="glass-card p-6">
                    <p className="text-[10px] font-black text-slate-600 uppercase tracking-widest mb-4">MCP preprompts</p>
