import { ChevronDown, Store, Tag, TrendingDown } from "lucide-react";
		...
		<div className="space-y-8 page-enter animate-in fade-in slide-in-from-bottom-4 duration-1000">
			...
			<div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
				...
				<div className="relative group overflow-hidden rounded-[2.5rem] border border-red-500/10 bg-[#0A0A0A] p-12 transition-all hover:border-red-500/30">
					...
					<p className="text-xl text-slate-400 font-medium leading-relaxed italic mb-10 max-w-lg">
						Focusing on regional quality and Bio-organic highlights from
						Natur*pur.
					</p>
				...
				<div className="relative group overflow-hidden rounded-[2.5rem] border border-amber-500/10 bg-[#0A0A0A] p-12 transition-all hover:border-amber-500/30">
					...
					<p className="text-xl text-slate-400 font-medium leading-relaxed italic mb-10 max-w-lg">
						Your neighborhood fresh market with exclusive JÖ bonus club
						highlights.
					</p>
					<div className="flex items-center gap-6">
						<div className="p-4 rounded-3xl bg-white/[0.03] border border-white/[0.06] flex-1">
				...
				{offers.map((offer, idx) => (
					...
					>
						<div className="flex justify-between items-start mb-8">
							<div
								className={`px-2 py-1 rounded bg-white/[0.03] border border-white/[0.08] flex items-center gap-2`}
							>
								<div
						...
						<div className="space-y-1 mb-8 h-12 flex flex-col justify-center">
							...
							<h4 className="text-sm font-black text-white uppercase tracking-tight leading-snug truncate group-hover:text-emerald-400 transition-colors">
								{offer.product}
							</h4>
						</div>
						...
						<div className="flex items-end justify-between pt-6 border-t border-white/[0.04]">
							...
							<button
								...
								className="p-3 rounded-2xl bg-white/[0.03] hover:bg-emerald-500/10 text-slate-500 hover:text-emerald-400 transition-all border border-transparent hover:border-emerald-500/20"
							>
